...
class ProductDB(Base):
    ...
    available_zipcodes = Column(JSONB, default=list)
    in_stock_zipcodes = Column(JSONB, default=list)
    all_zipcodes = Column(JSONB, default=list)
    category = Column(String(500), default="")
    tags = Column(JSONB, default=list)
    options = Column(JSONB, default=list)
    coupon_code = Column(String(255), default="")
    coupon_code_discount = Column(Float, default=0.0)
